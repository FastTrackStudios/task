...
// ── the agent sessions service, for core surfaces ───────────────────
//
// Two reads, and deliberately only two. Agents is an app and owns
// its conversations; these stay because a project page shows what
// is running against that project, and the presence roster shows
// agents mid-turn beside the people. Both are core surfaces asking
// a server capability a question, not the shell reaching into an
// app — the same arrangement as the invoicing and mealplan reads.
