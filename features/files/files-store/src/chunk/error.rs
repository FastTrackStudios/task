...
/// Errors returned by [`crate::chunk::ChunkStore`] and the manifest codec.
...
pub enum Error {
    ...
    /// A [`crate::chunk::ChunkerConfig`] fell outside the bounds
    ...
    /// [`crate::chunk::ChunkStore::gc`] was called on a store opened without
    /// chunk-level GC enabled (`ChunkStore::open`/`open_with_config`, not
    /// [`crate::chunk::ChunkStore::open_with_gc`]).
