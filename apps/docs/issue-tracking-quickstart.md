...
- `plans/issue-tracker-integration.md` — data model + Tracker traits + per-field sync
- `plans/workflows-orchestrator.md` — `Workflow` trait + Orchestrator runtime + handoff/resume
- `plans/workflow-coding.md` — `task code` CLI + commit-trailer attribution + auto-PR + beads migration
